...
public class RegisterRequest
{
    ...
    public RegisterRequest(String id, String firstName, String lastName, String phoneNumber, String email, String username, String password, String countryId, String address)
    {
        this.id = id;
